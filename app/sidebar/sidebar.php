    ...
    <div class="sidebar-container">
        <div class="sidebar-top-container">
            <div class="sidebar-top-topWrap">
                <img id="sidebar-top-left-avatar" src="https://ucarecdn.com/bee7dc80-10a2-4ebd-a48a-a50b8f78edb5/"
                    alt="" />
                <div class="sidebar-top-top-userWrap">
                    <div id="sidebar-top-top-user-name">Pamela</div>
                    <div id="sidebar-top-top-user-rank">Head Receptionist</div>
                </div>
            </div>
        ...
        <div class="sidebar-mid-container">
            ...
            <div class="inactive-sidebar-wrap" id="sidebar-mid-patientWrap">
                ...
                <div class="inactive-sidebar-text" id="sidebar-mid-patient-txt">Patient</div>
            </div>
