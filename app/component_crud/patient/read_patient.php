...
<body>
    ...
    $query = "
select *, medAid.medicalAid_organization
...
where ptnt.patient_id=ptnt.patient_id and ptnt.patient_medicalAid_id=medAid.medicalAid_id";
    ...
    while ($patient = mysqli_fetch_assoc($result)) {
        ...
        echo '<img style="height:100px;" class="patientItm_img" src="img/patients/' . $patient['patient_profile_url'] . '" alt="Patient profile"/>';
        ...
        echo '</div>';
        echo '<div class="patientItm_contactWrap">';
        echo '<div class="patientItm_contact">' . $patient['medicalAid_organisation']  . '</div>';
        echo '</div>';
        echo '</div>';
